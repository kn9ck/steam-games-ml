#train a binary classifier to predict whether a game will be successful or not. A game is successful if it has more than 500000 owners.
...
#Create chart of features importance
